...
public class ArrowSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String ARROW_CPU_MODEL_PROPERTY = "ro.soc.model";
    ...
    public static String getProcessorModel() {
        String cpuModelArrow = SystemProperties.get(ARROW_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelArrow.isEmpty()) {
            return cpuModelArrow;
